            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        {{-- form Create --}}
                        <form action="/panel/categories/{{ $category->id }}" method="post" class="form-inline" id="articleCreate">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label for="category-name" class="pr-1 form-control-label">Name</label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $category->name }}" required autocomplete="name" autofocus>
                                @error('name')
