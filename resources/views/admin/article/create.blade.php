            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        {{-- form Create --}}
                        <form action="{{ route('articles.store') }}" method="post" id="articleCreate" enctype="multipart/form-data">
                            @csrf
                            <!-- title -->
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="summary" id="article-summary" class="form-control @error('summary') is-invalid @enderror" rows="3">{{ old('summary') }}</textarea>
                                @error('summary')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mt-5 pt-4">
                                ...
                                <textarea name="content" id="article-content" class="form-control @error('content') is-invalid @enderror" rows="10">{{ old('title') }}</textarea>
                                @error('content')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
